...
public class WineFragment extends Fragment {
    public static final String ARG_WINE = "biz.agbo.baccus.controller.fragment.WineActivity.ARG_WINE";

    private static final String TAG = WineFragment.class.getSimpleName();
    private static final int SETTINGS_REQUEST  = 1;
    private static final String STATE_IMAGE_SCALE_TYPE = "biz.agbo.baccus.controller.fragment.WineFragment.STATE_IMAGE_SCALE_TYPE";
